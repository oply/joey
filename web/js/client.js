(function() {
    ...
    if(addClientButton) {
      ...
      layout.classList.add("layout__dashboard");
    });
  ...
  const targetPopinComplementary = document.querySelector(".open-complementary");
  ...
  const popinComplementary = document.querySelector('.edit__complementaryInfos');

  const popinAccountCancel = document.querySelector('.edit__accountInformation .cancel');
  const popinProcessCancel = document.querySelector('.edit__process .cancel');
  const popinComplementaryCancel = document.querySelector('.edit__complementaryInfos');
